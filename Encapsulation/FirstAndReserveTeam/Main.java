...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < n; i++) {
            ...
            Encapsulation.FirstAndReserveTeam.Person person = new Encapsulation.FirstAndReserveTeam.Person(input[0], input[1], Integer.parseInt(input[2]), Double.parseDouble(input[3]));
